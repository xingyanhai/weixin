...
/***/ function(module, exports, __webpack_require__) {
	...
	//引入jq
	var jq = __webpack_require__(14);
	//引人iscroll
	var IScroll = __webpack_require__(16);
	//console.log(iscroll);
	...
	$('#enter').click(function(){
		...
		/*$.post(
			"/api/skill",function(text,status){
		...
		var myScroll4 = new IScroll('#wrapper4', { mouseWheel: true });
		var myScroll5 = new IScroll('#wrapper5', { mouseWheel: true });
	...
	function moveToX(x){
		$("#footer>div").removeClass("footer-active");
		$("#footer>div").eq(x).addClass("footer-active");
	  	swiper2.slideTo(x, 500, true);//切换到第i个slide，速度为1秒
	};
	...
	$.post('https://xingyanhai.github.io/weixin/php/getsign.php',
		{
	    ...
	    function(data){
		    pos1=data.indexOf('{');
		    pos2=data.indexOf('}');
		    dataStr=data.substring(pos1-1,pos2+1);
	        ...
	        wx.config({
	            ...
	            jsApiList:[
	                'scanQRCode','getLoction','chooseImage','openLocation','onMenuShareAppMessage'
	            ]
			});
	...
	var sao = $("#header i").eq(0);
	var fenx = $("#header i").eq(1);  
	...
	wx.ready(function(){
	    ...
	    fenx.on('click',function(){
			wx.onMenuShareAppMessage({
			    title: '快来看我的简历', // 分享标题
			    desc: '这是我做的第一个简历', // 分享描述
			    link: 'http://1.xyhnnx.applinzi.com/www/index.html', // 分享链接
			    imgUrl: 'http://1.xyhnnx.applinzi.com/www/img/t.jpg', // 分享图标
...
/***/ function(module, exports, __webpack_require__) {
	...
	padding:"inner"+a,content:b,"":"outer"+a},function(c,d){n.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(d===!0||e===!0?"margin":"border");return Y(this,function(b,c,d){var e;return n.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?n.css(b,c,g):n.style(b,c,d,g)},b,f?d:void 0,f,null)}})}),n.fn.extend({bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}}),n.fn.size=function(){return this.length},n.fn.andSelf=n.fn.addBack,"function"=="function"&&__webpack_require__(15)&&!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function(){return n}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));var nc=a.jQuery,oc=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=oc),b&&a.jQuery===n&&(a.jQuery=nc),n},b||(a.jQuery=a.$=n),n});
